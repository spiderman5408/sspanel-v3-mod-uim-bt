...
wget -N --no-check-certificate "https://github.com/spiderman5408/ss-panel-v3-mod_Uim/archive/dev.zip"
unzip dev.zip
...
echo -e "${Info} github地址:https://github.com/spiderman5408/sspanel-v3-mod-uim-bt"
